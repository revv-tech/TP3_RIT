...
#   PATHS A LOS CSVs
testPath = os.path.realpath("...\\Archivos\\test-set.csv")
trainingPath = os.path.realpath("...\\Archivos\\training-set.csv")
classPath = os.path.realpath("...\\Archivos\\clases.csv")
...
def readClasesCSV(path):
    ...
    for classElem in classLine:
        newClass = ClassDocs(classElem[0], classElem[1], classElem[2],classElem[3])
